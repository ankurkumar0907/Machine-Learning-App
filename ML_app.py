...
Heart_Disease_models = pickle.load(open('Heart_disease_Predicition.sav',"rb"))

Tabular_Kidney_Stone_models = pickle.load(open('Tabular-kidney-stone_Prediction.sav','rb'))
